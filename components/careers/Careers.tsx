...
const Careers = () => {
  return (
    <section className='responsive-x-padding pt-10 '>
      <div>
        <Link href={'/'} className='text-lg text-slate-700 font-bold flex flex-row items-center w-max hover:bg-slate-200 active:bg-slate-100  px-4 py-2 rounded-4px'>
          ...
          <div className='bg-white rounded-md p-6 shadow-md shadow-indigo-50 flex flex-col justify-between' key={index}>
            ...
            <div className='border-t-2 pt-6'>
              <div className='flex flex-row justify-between items-center  gap-y-3 '>
                ...
                <Link href={'/'} className='text-center px-6 py-1 rounded-4px  bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-500 text-slate-50'>
